...
class App extends Component {
  state = {productList: initialData, searchInput: "", month: "March"}
  ...
  render() {
    const {productList, searchInput, month} = this.state
    const searchResult = productList.filter(
        each => each.category.includes(searchInput)
    )
    ...
    return (
      <div className='main-container'>
        ...
        <div className='search-card'>
            <input type='search' value={searchInput} placeholder='Search transaction' className='input' onChange={this.onChangeSearch} />

            <select value={month} className='input' onChange={this.onChangeMonth}>
